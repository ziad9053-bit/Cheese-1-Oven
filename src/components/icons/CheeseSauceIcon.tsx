...
const CheeseSauceIcon = ({ className = "w-12 h-12" }: { className?: string }) => {
  return (
    <svg 
    ...
    >
      ...
      />
      <circle cx="48" cy="55" r="1.5" fill="#FDE68A" />
      <circle cx="53" cy="75" r="2" fill="#FDE68A" />
    </svg>
  );
};

export default CheeseSauceIcon;
